...
def addPlanetSpawns(core, planet):
	...
	# Looped Patrol must end in same cell like the start point!!! dantari_raider
	#building id: 1105845                               Buildingid + cell !
	trehla = stcSvc.spawnObject('mission_mos_eisley_police_sergeant', 'tatooine', long(1105845 + 8), float(24.21), float(2.12), float(73.49), float(0.92), float(0), float(-0.38), float(0)) 
	print('NPC.getTemplate() ' + trehla.getTemplate())
